...
const route=useRouter()
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 px-2 py-2  dark:!bg-navy-800  md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        <div className="flex h-full items-center  text-navy-700 dark:bg-navy-900 dark:text-white xl:w-[225px]">
          ...
          /> */}
          <div className='flex items-center shadow-lg cursor-pointer px-3 py-2 rounded-full' onClick={()=>{
            dispatch(logoutUser())
            route.push("auth/sign-in/default")
            
          }}>
            <span className='mr-3'>
            <RiLogoutCircleLine className="text-inherit h-5 w-5"  />
            </span>
            <span  className="text-lg cursor-pointer font-normal capitalize text-navy-700  dark:text-white dark:hover:text-white" >
            Logout
            </span>
          </div>
